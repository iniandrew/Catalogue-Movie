...
public class MovieFavoriteWidget extends AppWidgetProvider {
    ...
    private static final String MOVIE_TOAST_ACTION = "com.andrew.moviecatalogue.TOAST_ACTION";
    public static final String MOVIE_EXTRA_ITEM = "com.andrew.moviecatalogue.EXTRA_ITEM";
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        toastIntent.setAction(MovieFavoriteWidget.MOVIE_TOAST_ACTION);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction() != null) {
            if (intent.getAction().equals(MOVIE_TOAST_ACTION)) {
                int viewIndex = intent.getIntExtra(MOVIE_EXTRA_ITEM, 0);
