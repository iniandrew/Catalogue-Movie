...
public class TvShowFavoriteWidget extends AppWidgetProvider {
    ...
    private static final String TVSHOW_TOAST_ACTION = "com.andrew.moviecatalogue.TOAST_ACTION";
    public static final String TVSHOW_EXTRA_ITEM = "com.andrew.moviecatalogue.EXTRA_ITEM";
    ...
    private static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        toastIntent.setAction(TvShowFavoriteWidget.TVSHOW_TOAST_ACTION);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction() != null) {
            if (intent.getAction().equals(TVSHOW_TOAST_ACTION)) {
                int viewIndex = intent.getIntExtra(TVSHOW_EXTRA_ITEM, 0);
